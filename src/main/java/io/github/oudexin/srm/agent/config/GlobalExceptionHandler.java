package io.github.oudexin.srm.agent.config;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(SrmRuntimeException.class)
    public ResponseEntity<Map<String, Object>> handleSrmRuntime(SrmRuntimeException e) {
        ResponseEntity<Map<String, Object>> response = buildResponse(HttpStatus.BAD_REQUEST, e.getMessage());
        response.getBody().put("errorCode", e.getCode());
        return response;
    }
